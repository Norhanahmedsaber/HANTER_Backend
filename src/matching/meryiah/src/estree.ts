...
export type Node =
  ...
  | JSXMemberExpression
  | JSXText
  | LabeledStatement //HANT NOT
  | Literal
  | LogicalExpression
  | MemberExpression
  | MetaProperty //HANT NOT
  | MethodDefinition
  | NewExpression //HANT NOT
  | ObjectExpression //HANT NOT
  | ObjectPattern //HANT NOT
  ...
  | ThrowStatement
  | TryStatement
  | UpdateExpression //HANT NOT
  | UnaryExpression //HANT NOT
  | VariableDeclaration
  | VariableDeclarator
  | WhileStatement
  | WithStatement
