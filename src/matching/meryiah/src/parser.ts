...
export function parseForStatement(
  ...
  line: number,
  column: number
): ESTree.ForStatement | ESTree.ForInStatement | ESTree.ForOfStatement | ESTree.ForGeneralStatement {
  nextToken(parser, context);
...
export function parseFunctionDeclaration(
  ...
  let id: ESTree.Identifier | ESTree.General | null = null;
...
export function parseParenthesizedExpression(
  ...
  while (parser.token !== Token.RightParen) {
    ...
    if (token & (Token.IsIdentifier | Token.Keyword | Token.General)) {
